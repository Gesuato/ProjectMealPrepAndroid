...
import com.easyprep.easyprep.ui.DetailMealPortionActivity
import com.easyprep.easyprep.ui.adapters.MealListAdapter
import com.easyprep.easyprep.ui.detailDailyPortionActivity.DetailDailyPortionActivity
...
class DayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        this.dailyPortionView.imgBtnDetailEdit.setOnClickListener {
            ...
            startActivityForResult(
                intent,
                REQUEST_DAILYPORTION
            )
        }

        this.mealListAdapter.setOnCustomItemClickListener(object :
    ...
    override fun onResume() {
        ...
        if (!valuesInCurrentDailyMealPlanIsChanged) {
            this.mealListAdapter.update(this.currentDailyMealPlan.meals as ArrayList)
            updateValuesInDailyPortionView()
        }
    }
    ...
    private fun showPopupCopy() {
        ...
        (0..5).forEach { index ->
            itemsPopup[index].imageButtonPopup.setOnClickListener {
